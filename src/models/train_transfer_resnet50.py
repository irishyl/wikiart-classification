...
def main():
    ...
    prefix_train = "train"
    prefix_val = "val"
    num_classes = 10  # Adjust to your actual number of classes
    ...
    trainer = TransferLearningTrainer(model_type="resnet50", num_classes=num_classes, epochs=5, learning_rate=1e-3)
